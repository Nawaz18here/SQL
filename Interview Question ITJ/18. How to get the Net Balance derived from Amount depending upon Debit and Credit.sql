--18. How to get the Net Balance derived from Amount depending upon Debit and Credit
...
Select *,SUM(Case when TranType='Credit' then (Amount) else -(Amount) end) OVER (Order by TranDate ) as Net_Balance
from Account_Table
