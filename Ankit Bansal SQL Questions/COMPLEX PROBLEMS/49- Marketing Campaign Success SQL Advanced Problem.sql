...
--49-Marketing Campaign Success SQL Advanced Problem | Step by Step Solution using CTEs
...
--ep.user_id,ep.created_at,ep.product_id,
--fp.user_id,fp.created_at,fp.product_id
from except_first_purchase ep
...
dense_rank() over(partition by user_id,product_id order by created_at) pr_rn
from marketing_campaign
)
